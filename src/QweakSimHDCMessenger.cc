...
{ 
  ...
  { 
     ...
     myHDC->SetFrontHDC_CenterPositionInX(HDC_FrontCenterPositionInX_Cmd->GetNewDoubleValue(newValue));
  }
  ...
  { 
      ...
      myHDC->SetFrontHDC_CenterPositionInY(HDC_FrontCenterPositionInY_Cmd->GetNewDoubleValue(newValue));
  }
  ...
  { 
     ...
     myHDC->SetFrontHDC_CenterPositionInZ(HDC_FrontCenterPositionInZ_Cmd->GetNewDoubleValue(newValue));
  }
  ...
  //-----------------------------------------------------------
   ...
   { 
      ...
      myHDC->SetBackHDC_CenterPositionInX(HDC_BackCenterPositionInX_Cmd->GetNewDoubleValue(newValue));
   }
   ...
   { 
       ...
       myHDC->SetBackHDC_CenterPositionInY(HDC_BackCenterPositionInY_Cmd->GetNewDoubleValue(newValue));
   }
   ...
   { 
      ...
      myHDC->SetBackHDC_CenterPositionInZ(HDC_BackCenterPositionInZ_Cmd->GetNewDoubleValue(newValue));
   }
  ...
  { 
     ...
     myHDC->SetHDC_RotationAngleInPhi(HDC_RotationAngleInPhi_Cmd->GetNewDoubleValue(newValue));
  }
