...
#ifndef QweakSimTungstenPlug_DetectorHit_h
#define QweakSimTungstenPlug_DetectorHit_h 1
...
class QweakSimTungstenPlug_DetectorHit : public G4VHit
{
...
typedef G4THitsCollection<QweakSimTungstenPlug_DetectorHit> QweakSimTungstenPlug_DetectorHitsCollection;

extern G4Allocator<QweakSimTungstenPlug_DetectorHit>  QweakSimTungstenPlug_DetectorHitAllocator;



/////// --------------------------------------------------------------------

inline void* QweakSimTungstenPlug_DetectorHit::operator new(size_t)
{
    void* aHit;
    aHit = (void*) QweakSimTungstenPlug_DetectorHitAllocator.MallocSingle();
    return aHit;
}
...
inline void QweakSimTungstenPlug_DetectorHit::operator delete(void* aHit)
{
    QweakSimTungstenPlug_DetectorHitAllocator.FreeSingle((QweakSimTungstenPlug_DetectorHit*) aHit);
}
