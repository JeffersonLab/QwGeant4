...
#ifndef QweakSimUserTungstenPlug_DetectorEvent_h
#define QweakSimUserTungstenPlug_DetectorEvent_h
...
class QweakSimUserTungstenPlug_DetectorEvent : public TObject
{
...
public:
    ...
    ClassDef(QweakSimUserTungstenPlug_DetectorEvent,1)
	
};  // end class QweakSimUserTungstenPlug_DetectorEvent 
